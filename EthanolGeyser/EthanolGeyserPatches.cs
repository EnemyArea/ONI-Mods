...
namespace EthanolGeyser
{
    public class EthanolGeyserPatches : UserMod2
    {
        ...
        public class Worlds_UpdateWorldCache_Patch
        {
            ...
            {
                var json = "{\"names\":[\"poi/poi_rust_geyser_ethanol\"],\"listRule\":5,\"someCount\":3,\"moreCount\":0,\"times\":3,\"priority\":10,\"allowDuplicates\":true,\"allowExtremeTemperatureOverlap\":false,\"useRelaxedFiltering\":false,\"allowedCellsFilter\":[{\"tagcommand\":3,\"tag\":\"AtDepths\",\"minDistance\":2,\"maxDistance\":10,\"command\":1,\"temperatureRanges\":[],\"zoneTypes\":[],\"subworldNames\":[]},{\"tagcommand\":0,\"tag\":null,\"minDistance\":0,\"maxDistance\":0,\"command\":4,\"temperatureRanges\":[],\"zoneTypes\":[7],\"subworldNames\":[]},{\"tagcommand\":0,\"tag\":null,\"minDistance\":0,\"maxDistance\":0,\"command\":1,\"temperatureRanges\":[],\"zoneTypes\":[0],\"subworldNames\":[]},{\"tagcommand\":1,\"tag\":\"NoGlobalFeatureSpawning\",\"minDistance\":0,\"maxDistance\":0,\"command\":4,\"temperatureRanges\":[],\"zoneTypes\":[],\"subworldNames\":[]}]}";
        ...
        public class GeyserGenericConfig_GenerateConfigs_Patch
        {
            private static void Postfix(List<GeyserGenericConfig.GeyserPrefabParams> __result)
            {
                ...
                __result.Add(new GeyserGenericConfig.GeyserPrefabParams("geyserliquidethanolchilled_kanim", 4, 2, new GeyserConfigurator.GeyserType(Id, SimHashes.Ethanol, 263.15f, 1000f, 2000f, 500f, 60f, 1140f, 0.1f, 0.9f, 15000f, 135000f, 0.4f, 0.8f)));
            }
        }
    }
}