...
namespace BalanceWaterPumpConsumption.Properties
{
	...
	internal class Resources
	{
		...
		internal static ResourceManager ResourceManager
		{
			get
			{
				...
				if (flag)
				{
					ResourceManager resourceManager = new ResourceManager("BalanceWaterPumpConsumption.Properties.Resources", typeof(Resources).Assembly);
